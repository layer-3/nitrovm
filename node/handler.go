...
func (s *Server) handleInstantiate(w http.ResponseWriter, r *http.Request) {
	...
	if err := s.persistBalance(dbTx, res.ContractAddress); err != nil {
		dbTx.Rollback()
		writeErr(w, http.StatusInternalServerError, "persist balance: "+err.Error())
		return
	}
...
func (s *Server) handleExecute(w http.ResponseWriter, r *http.Request) {
	...
	if err := s.persistBalance(dbTx, contract); err != nil {
		dbTx.Rollback()
		writeErr(w, http.StatusInternalServerError, "persist balance: "+err.Error())
		return
	}
...
func (s *Server) handleFaucet(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := s.db.Exec("INSERT OR REPLACE INTO accounts (address, balance, nonce) VALUES (?, ?, 0)", req.Address, req.Amount.String()); err != nil {
